...
\textbf{Haryana}, and \textbf{Rajasthan} have the highest concentration of
underperforming districts. Haryana districts dominate the top of the production
loss ranking, driven by Wheat and cotton yield gaps.

\subsection{Top Districts by Production Loss}
The ranked bar chart identifies the top districts by loss potential (forgone
production against the median), with Haryana and Rajasthan dominating:
...
\begin{table}[H]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    Hanumangarh   & Rajasthan  & 17.1 \\
    Ganganagar    & Rajasthan  & 8.1  \\
    Anantapur     & Andhra Pradesh & 5.5 \\
    Bikaner       & Rajasthan  & 5.5  \\
    Kurnool       & Andhra Pradesh & 5.3 \\
    Murshidabad   & West Bengal & 4.5 \\
    Jind          & Haryana    & 4.5  \\
    Hisar         & Haryana    & 4.1  \\
    Fatehabad     & Haryana    & 4.1  \\
    Kaithal       & Haryana    & 4.0  \\
    \bottomrule
  \end{tabular}
\end{table}

\textbf{Hanumangarh} (Rajasthan) leads with 17.1M tonnes of loss potential —
more than double the second-ranked Ganganagar. The prevalence of Haryana and
Rajasthan districts reflects Wheat and oilseed yield gaps in semi-arid zones,
a contrast to the earlier Chhattisgarh-Sugarcane pattern seen in cumulative data.
...
\begin{kpibox}{Portfolio KPIs}
  \begin{center}
    \begin{tabular}{ccc}
      ...
      \small Fastest CAGR (25\%) & \small Top Yield State (10.3 T/Ha) & \small Crop Varieties
    \end{tabular}
  \end{center}
\end{kpibox}
...
\begin{insightbox}
  \textbf{6.} \textbf{Hanumangarh} (Rajasthan) carries 17.1M tonnes of production
  loss potential in 2019 — the highest single district — driven by Wheat yield
  gaps, making it the top-priority intervention target.
\end{insightbox}
...
(high-yield variety seeds, micro-irrigation) in the top 30 underperforming
districts ranked by Production Loss Potential — starting with Hanumangarh,
Ganganagar, and Anantapur. A 10\% yield improvement in these 30 districts
alone could recover several billion tonnes of annual production nationally.
...
Yet the scale of underperformance remains staggering: 705 of 707 districts fall
